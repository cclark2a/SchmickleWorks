        ...
        if (1 == notesTied) {
            ...
            do {
                do {
                    ...
                    DEBUG("InStd %u FromMidi %u FromStd %u LtOrEq %d", inStd,
    ...
    for (auto& noteCache : cache) {
        ...
        switch (note.type) {
            ...
            case REST_TYPE: {
                    ...
                    if (ntw()->debugVerbose) DEBUG("%d track_pos xOff %g cache start %d dur %d", &noteCache - &cache.front(),
